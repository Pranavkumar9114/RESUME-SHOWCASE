...
class productgrid3 extends StatefulWidget {
  const productgrid3({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _productgrid3State createState() => _productgrid3State();
}

// ignore: camel_case_types
class _productgrid3State extends State<productgrid3> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final productData = {
          ...
          'price': productPrice ?? 'No price available', 
  ...
  Future<void> fetchBarcodeList() async {
    ...
    try {
      final snapshot =
          await firestore.collection('barcodes').doc('barcode_data3').get();
...
void main() {
  runApp(const MaterialApp(home: Scaffold(body: productgrid3())));
}
